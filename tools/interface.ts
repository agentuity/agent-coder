...
export const toolDescriptions = {
  read_file: 'Read the contents of a file. Use this to examine existing code or configuration files.',
  ...
  git_diff: 'Show git diff for changed files with beautiful formatting. Use this to see what has changed in the repository.',
  set_work_context: 'Set the current work context and goals for the session. Use this to remember what we are working on.',
  get_work_context: 'Get the current work context and goals. Use this when user asks "what are we working on" or to continue previous work.',
};
